...
<div align="center">
  ...
  <h1>webpack Dev Middleware Hard Disk</h1>
</div>
...
In the server-side rendering mode, __webpack-dev-middleware-hard-disk__ sets the `stat` to `res.locals.webpackStats` before invoking the next middleware, allowing a developer to render the page body and manage the response to clients.
